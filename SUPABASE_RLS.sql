...
CREATE POLICY "Admin can completely manage users" ON public.users FOR ALL USING (auth.jwt() ->> 'email' = 'tradonyx@vault.com');

-- === PROFILES ===
CREATE POLICY "Users can view own profile" ON public.profiles FOR SELECT USING (auth.uid() = id);
CREATE POLICY "Users can insert own profile" ON public.profiles FOR INSERT WITH CHECK (auth.uid() = id);
CREATE POLICY "Users can update own profile" ON public.profiles FOR UPDATE USING (auth.uid() = id);
CREATE POLICY "Admin can completely manage profiles" ON public.profiles FOR ALL USING (auth.jwt() ->> 'email' = 'tradonyx@vault.com');
...
CREATE POLICY "Admin can completely manage accounts" ON public.accounts FOR ALL USING (auth.jwt() ->> 'email' = 'tradonyx@vault.com');
...
CREATE POLICY "Admin can completely manage trades" ON public.trades FOR ALL USING (auth.jwt() ->> 'email' = 'tradonyx@vault.com');
...
CREATE POLICY "Admin can completely manage challenges" ON public.challenges FOR ALL USING (auth.jwt() ->> 'email' = 'tradonyx@vault.com');

-- === PAYMENTS ===
CREATE POLICY "Users can view own payments" ON public.payments FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can insert own payments" ON public.payments FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Admin can completely manage payments" ON public.payments FOR ALL USING (auth.jwt() ->> 'email' = 'tradonyx@vault.com');
