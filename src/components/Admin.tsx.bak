  ...
  return (
    <div className="space-y-6 animate-scale-in text-slate-200">
      ...
      <div className="bg-[var(--bg-secondary)] rounded-2xl p-6 border border-white/[0.06] space-y-4">
        ...
        <div className="bg-[var(--bg-tertiary)] p-4 rounded-xl border border-white/[0.06] h-64 overflow-y-auto font-mono text-[10px] space-y-1">
      ...
      <div className="bg-[var(--bg-secondary)] rounded-2xl p-6 border border-white/[0.06] space-y-4">
        ...
        <div className="overflow-x-auto border border-white/[0.06] rounded-xl bg-[var(--bg-secondary)]/40 font-mono text-[11px]">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[var(--bg-tertiary)] border-b border-white/[0.06] text-slate-500 text-[10px] font-bold uppercase tracking-wider">
      ...
      <div className="bg-[var(--bg-secondary)] rounded-2xl p-6 border border-white/[0.06] space-y-4">
        ...
        <div className="overflow-x-auto border border-white/[0.06] rounded-xl bg-[var(--bg-secondary)]/40">
      ...
      <div className="bg-[var(--bg-secondary)] rounded-2xl p-6 border border-white/[0.06] space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            ...
            <div className="flex gap-4 text-[10px] uppercase font-mono font-black text-slate-400 bg-slate-950/60 px-3 py-1.5 rounded-lg border border-white/[0.06]">
